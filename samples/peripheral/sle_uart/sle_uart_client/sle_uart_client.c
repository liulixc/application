...
// ================== 全局变量与Getter ==================
static ssapc_find_service_result_t g_sle_uart_find_service_result = { 0 }; // 服务发现结果
static sle_announce_seek_callbacks_t g_sle_uart_seek_cbk = { 0 };          // 扫描相关回调
static sle_connection_callbacks_t g_sle_uart_connect_cbk = { 0 };          // 连接相关回调
static ssapc_callbacks_t g_sle_uart_ssapc_cbk = { 0 };                     // SSAPC回调
static sle_addr_t g_sle_uart_remote_addr = { 0 };                          // 远端设备地址
ssapc_write_param_t g_sle_uart_send_param = { 0 };                         // 发送参数
uint16_t g_sle_uart_conn_id = 0;                                           // 当前连接ID
